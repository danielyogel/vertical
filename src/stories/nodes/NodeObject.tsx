...
export function NodeObject<V extends Record<string, any>, S extends Record<string, any>>(
  params: BaseParams<V, S, _node<NoInfer<V>, NoInfer<S>>> & { children: Children<NoInfer<V>, NoInfer<S>> }
) {
  return flow(
